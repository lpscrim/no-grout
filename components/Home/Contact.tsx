...
export default function Contact() {
  return (
    <section id="contact" className="isolate bg-primary px-6 py-24 sm:py-32 lg:px-8 section-dark">
      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            <label htmlFor="first-name" className="block text-sm/6 font-semibold text-background ">
              First name
            </label>
          ...
          <div>
            <label htmlFor="last-name" className="block text-sm/6 font-semibold text-background ">
              Last name
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div className="sm:col-span-2">
            <label htmlFor="company" className="block text-sm/6 font-semibold text-background ">
              Company
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div className="sm:col-span-2">
            <label htmlFor="email" className="block text-sm/6 font-semibold text-background ">
              Email
            </label>
            <div className="mt-2.5">
              <input
          ...
          <div className="sm:col-span-2">
            <label htmlFor="phone-number" className="block text-sm/6 font-semibold text-background ">
              Phone number
            </label>
            <div className="mt-2.5">
          ...
          <div className="sm:col-span-2">
            <label htmlFor="message" className="block text-sm/6 font-semibold text-background ">
              Message
            </label>
            <div className="mt-2.5">
              <textarea
